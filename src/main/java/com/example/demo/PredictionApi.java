...
public class PredictionApi {
  ...
  public static void main(String[] args) throws IOException {
    ...
    String projectId = "satishreddy-141013";
    String computeRegion = "us-central1";
    String modelId = "TRL8619019074274303616";
    predict(projectId, computeRegion, modelId, "D:\\translate.txt");
    System.out.println("projectId>>:"+ projectId  + computeRegion);
